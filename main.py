...
async def message_not_modified(update: types.Update, exception: exceptions.CantInitiateConversation) -> bool:
    return True


@dp.errors_handler(exception=exceptions.RetryAfter)
async def flood_wait_retry_after(update: types.Update, exception: exceptions.RetryAfter) -> bool:
...
async def serverStatus(call: types.CallbackQuery) -> None:
